    ...
    <div>
        <modal :show="show" @close="close">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <h1 class="text-3xl text-slate-600 py-5 mb-4 text-left">Edit Property Details</h1>
        <form @submit.prevent="update" >
          <div class="shadow overflow-hidden sm:rounded-md">
            ...
            <div class="flex px-4 py-3 bg-gray-50 text-right sm:px-6 justify-between">
              <div @click="close" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mr-3 cursor-pointer">Cancel</div>
...
<script>
    ...
    export default defineComponent({
        props: [
            'show', 'id', 'streetAddress', 'city', 'province', 'postalCode', 'userId'
